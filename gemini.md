...
* **Instructional Depth (Visual Cues & Fail-States):** Don't just say "whisk" or "bake". Explicitly define *how long* to perform an action and exactly *what* it should look or act like. Teach the reader how to know it's done and what happens if they fail to hit specific visual cues. Never use the generic phrase "Visual Cue: Look for a golden, blistering crust. If it looks pale, it will taste like wet cardboard." as it does not make sense for non-baked recipes.
