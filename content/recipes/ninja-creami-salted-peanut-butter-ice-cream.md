...
meta: {
  seoMetaDescription: "Make a creamy, high-protein Salted Peanut Butter Ice Cream in your Ninja Creami. A guilt-free, delicious dessert with over 70g of protein."
} 
description: "Satisfy your sweet tooth with this incredibly creamy, high-protein Salted Peanut Butter Ice Cream made right in your Ninja Creami. By combining rich peanut butter powder, a scoop of your favorite vanilla protein, and a touch of sea salt, you get a decadent, guilt-free treat that tastes like it came straight from an artisan scoop shop."
...
tips:
  ...
  - "Mix-In Magic: After it's perfectly creamy, create a well in the center and use the mix-in function to fold in dark chocolate chips or crushed peanuts for an ultimate crunch."
...
works:
  - "Protein Power: Using a combination of whey or casein protein with peanut butter powder builds a thick, creamy structure without the heavy fat of traditional egg yolks."
...
rating: 
variations:
  - "Chocolate Peanut Butter: Add 1 tbsp of cocoa powder to the liquid base before freezing."
  - "PB&J Swirl: Core out the center after spinning and add a dollop of strawberry jam, then use the mix-in function."
reviews: 
servingSuggestions: "Serve this rich, salty-sweet peanut butter ice cream with a drizzle of sugar-free chocolate syrup and a sprinkle of flaky sea salt on top. For an extra textural contrast, toss a handful of crushed roasted peanuts or sugar-free chocolate chips over the top right before eating. Fresh raspberries also make a fantastic addition, adding a bright, tart contrast to the rich peanut butter flavor."
...
why:
  ...
  - "No Gums Necessary: Thanks to the protein powder and peanut butter, you can get a great texture without needing extra stabilizers."
prepTimeMins: 5
cookTimeMins: 5
servings: 1
macros:
  ...
  fat: 11
ingredients:
  - { item: "Low fat milk", amount: 400, unit: "ml" }
  - { item: "Vanilla whey protein powder", amount: 60, unit: "g" }
  - { item: "Peanut butter powder (PB2)", amount: 30, unit: "g" }
  - { item: "Honey", amount: 30, unit: "g" }
  - { item: "Vanilla extract", amount: 1, unit: "tsp" }
  - { item: "Sea salt", amount: 0.25, unit: "tsp" }
...
faq:
  ...
  - question: "Can I use real peanut butter instead of powdered?"
    answer: "Yes, but it will significantly increase the fat and calorie content. We use a mix of both to balance the macros while keeping the rich peanut flavor intact."
...
steps:
  - "In a blender or a shaker bottle, combine the low-fat milk, vanilla protein powder, peanut butter powder, honey, vanilla extract, and sea salt. Blend or shake vigorously until the mixture is completely smooth and lump-free."
