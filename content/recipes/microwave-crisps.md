...
description: 'Crisps do not have to ruin your training goals. Heating them in the microwave is a brilliant hack that draws the moisture right out of the potato slices, leaving them incredibly crunchy. It took me a few goes to dial in the perfect timing so they do not catch, but now we have got a quick snack that delivers pure texture with zero unnecessary oil.'
...
works:
- 'Steam-Zap Hack: The microwave directly targets water inside the potato slices. This rapid steaming dries the slices out fast, forcing the potato starches to harden into an incredibly thin, crispy snap.'
- 'Starch Rinse: Soaking the slices in cold water washes away excess surface starch. This ensures the chips crisp up independently instead of sticking together in a gummy heap.'
use:
...
- Microwave on high for 3 minutes. Flip them, then go another 2 minutes. Keep heating in 1-minute increments until they turn golden brown and firm. If they bend when you pick them up, they aren't done.
