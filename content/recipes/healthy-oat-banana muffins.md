...
description: |
  A macro-balanced powerhouse that actually tastes like a proper dessert. Packing serious protein and clean carbs, we've binned the refined flour for oats and Greek yoghurt.
  
  These easy 15-minute muffins require minimal prep and deliver maximum flavour. Tested multiple times to perfectly balance the dense oat flour against the natural banana moisture, ensuring a fudgy texture that doesn't dry out into ash.
blurb: []
...
ingredients:
  ...
  - { item: "Egg", amount: 1 }
  - { item: "Oat flour", amount: 100, unit: "g" }
  - { item: "Baking powder", amount: 0.5, unit: "tsp" }
  - { item: "Cocoa powder", amount: 2, unit: "tbsp" }
  - { item: "Greek yoghurt", amount: 2, unit: "tbsp" }
