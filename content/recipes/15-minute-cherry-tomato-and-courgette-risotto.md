...
rating: null
reviews: null
servingSuggestions: Perfect on its own, or pair with a slice of garlic ciabatta to
  mop the bowl. A sharp rocket (arugula) salad cuts through the heavy creaminess perfectly.
storageInstructions: Fridge for 3 days. Reheat with a splash of boiling water. Don't
  freeze it, the rice turns to a grainy mess.
prepTimeMins: 0
cookTimeMins: 15
servings: 1
macros:
...
- question: Do I have to use Arborio rice?
  answer: Mandatory. Short-grain Arborio holds the starch needed for the creamy texture.
    Standard long-grain will just turn into wet rice.
