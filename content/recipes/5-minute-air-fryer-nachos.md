...
tipsTitle: "Pro Tip"
tips:
  - "Grate your own cheese: always grate from a block. Those pre-shredded bags are coated in anti-caking dust that wrecks the melt."
  - "Strategic layering: don't just dump the cheese on top. Build two distinct layers so every single chip gets some action."
  - "The parchment sling: build your nachos on a sheet of parchment paper inside the basket. When they finish cooking, just lift the whole thing out."
works:
  - "Dry heat vs. microwave: microwaves steam chips and produce soggy, limp results. Air fryers keep chips crisp."
...
rating: 
reviews: 
servingSuggestions: "Eat these immediately. Pair them with guacamole, fresh pico de gallo, and sour cream. Wash it down with a zero-sugar soda."
storageInstructions: "Eat them immediately. Leftovers turn into a soggy mess in the fridge. Do not freeze them."
prepTimeMins: 0
cookTimeMins: 5
servings: 1
macros:
  ...
  fat: 35
ingredients:
  - { item: "Tortilla chips", amount: 50, unit: 'g'} 
...
faq:
  - question: "Can I use a microwave instead of an air fryer?"
    answer: "You could, but the chips will turn into a soggy mess. The air fryer is essential. It keeps the tortilla chips crispy and ensures the cheese melts perfectly."
  - question: "What are the best tortillas to use?"
    answer: "Thick, restaurant-style corn tortilla chips work best. They hold up to the weight of the melted cheese without snapping in half."
