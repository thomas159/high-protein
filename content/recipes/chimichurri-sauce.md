...
reviews: null
servingSuggestions: Spoon this generously over freshly grilled seitan steaks or thick
  cauliflower steaks. Brilliant as a dipping sauce with warm, crusty bread.
storageInstructions: Airtight jar in the fridge for a week. The olive oil will solidify,
  so let it sit at room temp for 10 minutes before using. Freezes fine in ice cube
  trays.
prepTimeMins: 0
cookTimeMins: 5
servings: 1
...
- item: Oregano
  amount: 0.25
  unit: tsp
- item: Red chilli finely chopped
  amount: 1
- item: Salt
  amount: 0.25
  unit: tsp
