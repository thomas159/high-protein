...
<template>
  ...
  >
    ...
    <div class="p-2 flex-grow flex flex-col">
      ...
      <h2 class="font-display text-base font-extrabold text-foreground mb-2 group-hover:text-green-600 dark:group-hover:text-green-400 md:line-clamp-3 leading-tight">
        {{ props.recipe.title }}
      </h2>
