...
<template> 
 <div class="flex flex-wrap gap-2 mb-5">
    <span v-for="tag in props.recipe.tags" :key="tag" class="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-sm font-semibold bg-green-500/10 text-green-600 dark:text-green-400 border border-green-500/30">
